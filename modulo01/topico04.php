            ...
            <div class="main-content container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <!-- Parágrafo com a biblioteca de animação  -->
                        <p class="wow fadeIn" data-wow-delay="0.3s">Conhecer critérios de qualidade e seguir processos
                            de fabricação que
                        ...
                        <!-- Parágrafo com a biblioteca de animação  -->
                        <p class="wow fadeIn" data-wow-delay="0.3s">Avaliar a qualidade de uso e corrigir os problemas
                            identificados
                        ...
                        <!-- subtopico -->
                        <h3 class="Subtopico fw-bolder wow fadeIn" data-wow-delay="0.3s" id="item4.2"> 4.2 - Como
                            Avaliar</h3>
                        <!-- subtopico -->

                        <!-- Parágrafo com a biblioteca de animação  -->
                        <p class="swow fadeIn" data-wow-delay="0.3s"> É possível avaliar a usabilidade tomando como base
                            uma das definições
                        ...
                        <!-- Parágrafo com a biblioteca de animação  -->
                        <p class="wow fadeIn" data-wow-delay="0.3s">A avaliação pode ocorrer de três formas:
                        ...
                        <div class="accordion wow fadeIn" data-wow-delay="0.3s" id="accordionExample">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body" id="acordion-estilizado">
                                        <strong>que ocorre através de coleta de informação e opinião dos
                                            usuários acerca de suas necessidades e desejos. Por exemplo,
                                            questionários e entrevistas.</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <strong>são realizadas por especialistas e não envolvem diretamente
                                            os usuários. Por exemplo, avaliação heurística.</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <strong>coletam os dados sobre o uso do sistema pelos usuários,
                                            que pode ocorrer em laboratório ou em campo. Por exemplo, teste de
                                            usabilidade com usuários reais.</strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s"> Uma avaliação pode buscar respostas sobre
                            ...
                            <ul class="list">
                                <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i
                                    ...
                                    usuários;</li>
                                <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i
                                        class="fa fa-dot-circle text-success"></i>os objetivos e necessidade dos
                                    usuários;
                                </li>
                                <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i
                                ...
                                <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i
                                        class="fa fa-dot-circle text-success"></i>atividades antes e depois da
                                    intervenção
                                    com o sistema;</li>
                                <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i
                                        class="fa fa-dot-circle text-success"></i>a conformidade com um padrão;</li>
                                <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i
                                        class="fa fa-dot-circle text-success"></i>ideias e alternativas de design; e
                                </li>
                                <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i
                                        class="fa fa-dot-circle text-success"></i>diferentes alternativas de solução.
                                </li>
                            </ul>
                            <!-- fim da lista  -->

                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s">Para realizar uma avaliação é necessário decidir
                                como ela irá ocorrer, em
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s">A avaliação heurística, também chamada de
                                inspeção heurística, é um
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s"> Esse método orienta os avaliadores a realizarem
                                uma inspeção
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s">Para cada problema encontrado é comum
                                estabelecer um nível de
                                severidade que segue a <strong>Tabela 01.</strong> Além do grau de severidade, o
                                problema
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s">Apesar de parecer óbvio, <strong> uma avaliação
                                    heurística encontra
                            ...
                            <!-- Parágrafo com a biblioteca de animação  -->
                            <p class="wow fadeIn" data-wow-delay="0.3s"> Uma avaliação heurística pode utilizar-se de
                                outras heurísticas ou regras.
                                ...
                                <div class="accordion ">
                                    <section id="content">
                                        ...
                                        <div class="accordion-content" id="Curiosidade">
                                            ...
                                            <p class="txt-caixasecundaria">Abra e copie (ou baixe) esta planilha de
                                                suporte
                                                ...
                                                Realize uma avaliação heurística neste sistema: <a
                                                    href="https://userinyerface.com/" target="_blank"> User Inyerface -
                                                    A
                                                    worst
