                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <!-- COMEÇO REFERÊNCIAS  -->
                            ...
                            <p class="Texto"> <i class="bi bi-book "></i> ASSOCIAÇÃO BRASILEIRA DE NORMAS TÉCNICAS. NBR 9241-11:
                            ...
                            <p class="Texto"> <i class="bi bi-book"></i><strong> ISO/IEC 25000 </strong>Software and system engineering–Software product
                                Quality Requirements and Evaluation (SQuaRE) - Guide to SQuaRE.
                                International Organization for Standarization, 2014.</p>

                            <p class="Texto"> <i class="bi bi-book"></i><strong> ISO. ISO/IEC 25010:</strong> 2011 (2011). Systems and software engineering--
                                Systems and software Quality Requirements and Evaluation (SQuaRE)--
                                System and software quality models. Geneva, 2011. </p>
                            <p class="Texto"> <i class="bi bi-book"></i><strong> ABREU, L. M. Usabilidade de telefones celulares com base em
                                    critérios ergonômicos.</strong> Tese de Mestrado pelo Programa de PósGraduação em Design do Departamento de Artes & Design, PUC-Rio.
                                Rio de Janeiro. 2005. </p>
                            <p class="Texto"> <i class="bi bi-book"></i> REBELO, Irla B.<strong>Usabilidade e suas metas.</strong> Apostila. Brasília, DF. Última
                                atualização em novembro de 2009. Disponível em
                                <a href="irlabr.wordpresss.com">irlabr.wordpresss.com</a>.
                            </p>
                            <p class="Texto"> <i class="bi bi-book"></i> NIELSEN, J. (2012, January 3). <strong>Usability 101: Introduction to Usability.</strong>
                            ...
                            <p class="Texto"> <i class="bi bi-book"></i> BARBOSA, Simone; SILVA, Bruno. <strong>Interação humano-computador.</strong>
                                Elsevier Brasil, 2010. </p>
                            <p class="Texto"> <i class="bi bi-book"></i>NIELSEN, J. (1994, April 24). <strong> Usability Heuristics for User Interface
