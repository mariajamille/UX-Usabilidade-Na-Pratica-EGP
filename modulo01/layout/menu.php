    ...
    <ul>
        ...
        <!-- <div class="dropdown-container" id="spy">
            <a href="topico03.php">
                <i class="fa-regular fa-pen-to-square circulo"></i>Início</a>
            <a href="#item3.1">
                <i class="fa-regular fa-pen-to-square circulo"></i>3.1 - Visibilidade de qual estado estamos no sistema</a>
            <a href="#item3.2">
                <i class="fa-regular fa-pen-to-square circulo"></i>3.2 - Correspondência entre o sistema e o mundo real</a>
            <a href="#item3.3">
                <i class="fa-regular fa-pen-to-square circulo"></i>3.3 - Liberdade de controle fácil pro usuário</a>
            <a href="#item3.4">
            ...
            <a href="#item3.6">
                <i class="fa-regular fa-pen-to-square circulo"></i>3.6 - Reconhecimento em vez de memorização</a>
            <a href="#item3.7">
                <i class="fa-regular fa-pen-to-square circulo"></i>3.7 - Flexibilidade e Eficiência de Uso</a>
            <a href="#item3.8">
                <i class="fa-regular fa-pen-to-square circulo"></i>3.8 - Estética e design minimalista</a>
            <a href="#item3.9">
                <i class="fa-regular fa-pen-to-square circulo"></i>3.9 - Ajude os Usuários a Reconhecerem, Diagnosticarem e
