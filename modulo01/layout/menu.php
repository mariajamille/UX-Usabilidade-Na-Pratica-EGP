    ...
    <ul>
        ...
        <div class="dropdown-container" id="spy">
            <a href="topico03.php">
                <i class="fa-regular fa-pen-to-square circulo"></i>Início</a>
            <a href="#item1">
                <i class="fa-regular fa-pen-to-square circulo"></i>Visibilidade de qual estado estamos no sistema</a>
            <a href="#item2">
                <i class="fa-regular fa-pen-to-square circulo"></i>Correspondência entre o sistema e o mundo real</a>
            <a href="#item3">
                <i class="fa-regular fa-pen-to-square circulo"></i>Liberdade de controle fácil pro usuário</a>
            <a href="#item4">
            ...
            <a href="#item6">
                <i class="fa-regular fa-pen-to-square circulo"></i>Reconhecimento em vez de memorização</a>
            <a href="#item7">
            ...
            <a href="#item9">
                <i class="fa-regular fa-pen-to-square circulo"></i>Ajude os Usuários a Reconhecerem, Diagnosticarem e
